...
const StyledNavDropdown = styled(NavDropdown)`
  ...
  > a:first-child {
    ...
    margin: 15px 10px;
    border-bottom: ${props =>
      props.links.includes(props.location) ? "2px solid black" : "none"};
    :hover {
      opacity: 60%;
    }
  }
...
const DropdownItem = styled(NavDropdown.Item)`
  background-color: ${props =>
    props.location === props.href ? "white" : "none"} !important;
`
              ...
              <Container>
                ...
                <Navbar.Collapse id="collapsible-navbar-nav">
                  <Nav className="mr-auto ml-auto">
                    <StyledLink href="/" location={location.pathname}>
                      Home
                    </StyledLink>
                    <StyledNavDropdown
                      title="私たちについて"
                    ...
                    >
                      ...
                      <DropdownItem href="/team/" location={location.pathname}>
                        チーム
                      </DropdownItem>
                      <DropdownItem
                        href="/reports/"
                    ...
                    <StyledLink href="/news/" location={location.pathname}>
                      ニュース
                    </StyledLink>
                    <StyledLink href="/contact/" location={location.pathname}>
                      問い合わせ
                    </StyledLink>
                    <DonationLink>
                      <StyledLink
