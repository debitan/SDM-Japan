...
const About = () => {
    ...
    return (
        <ImageDiv>
            <StyledImg fluid={sanityHomePage.supportedDecisionMakingImage.image.asset.fluid} alt={sanityHomePage.supportedDecisionMakingImage.caption.ja} />
            <OverlayContainer>
                <Wrapper>
                    <WhiteH3>{sanityHomePage.supportedDecisionMakingTitle.ja}</WhiteH3>
                    <Text><BlockContent blocks={sanityHomePage._rawSupportedDecisionMaking.ja} serializers={serializers} /></Text>
                </Wrapper>
            </OverlayContainer>
        </ImageDiv>
    )
